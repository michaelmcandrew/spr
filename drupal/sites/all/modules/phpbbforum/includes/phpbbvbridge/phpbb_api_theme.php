<?php
// $Id: phpbb_api_theme.php,v 1.5 2009/05/18 18:13:30 vb Exp $
/**
...
function theme_phpbb_api_recent_posts($posts, $options) {
  ...
  $strposts .= $output_tag;
    ...
    if ($post['TOPIC_ICON_IMG'] != '') {
      $strimgicon = '<a href="'. $post['U_VIEW_POST'] .'"><img src="'. $phpbb_url .'/images/icons/'. $post['TOPIC_ICON_IMG'] .'" alt="'. $shorten_subject .'" title="'. $shorten_subject .'" /></a>';
      $strimgicon .= '&nbsp;';
    }
